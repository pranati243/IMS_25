...
(6, 10, '2005', 'CSE-101', 'cse@university.edu', '1234567890', 101, 'To excel in computer education', 'Empowering students with programming skills', 25, 500, 'https://cse.university.edu', 'Ranked top 5 in national coding competitions', 'Partnership with Google and Microsoft', 'Artificial Intelligence, Cybersecurity'),
...
(8, 30, '2002', 'ECE-103', 'ece@university.edu', '1234567892', 103, 'Enhancing communication technology', 'Pioneering research in electronics', 22, 400, 'https://ece.university.edu', 'Students won national circuit design competition', 'MoU with semiconductor companies', 'VLSI, Embedded Systems'),
...
(10, 50, '2008', 'IT-105', 'it@university.edu', '1234567894', 105, 'Advancing IT education and research', 'Focusing on real-world applications of IT', 15, 250, 'https://it.university.edu', 'Students won Hackathon 2024', 'MoU with top software companies', 'Cloud Computing, Data Analytics');
...
(12, 6, 105, 'Institution of Engineers India', 'National', '2015-11-25', '2025-11-25', 'Member', 'Chartered Engineer', 'IEI-741852', 'UID-IEI106', 'Industry-academia collaboration for Engineering students', NULL, 'Advisory Board', 'Mentor & Guide', 95);
